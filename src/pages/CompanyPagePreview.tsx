...
export const CompanyPagePreview: React.FC = () => {
  ...
  const handleCopyLink = () => {
    const url = `${window.location.origin}/company-preview/${upperSymbol}`;
  ...
  const handlePeerClick = (peerSym: string) => {
    navigate(`/company-preview/${encodeURIComponent(peerSym.toUpperCase())}`);
