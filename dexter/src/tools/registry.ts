...
import { createGetFinancials, createGetMarketData, createReadFilings, createScreenStocks, getCongressionalTrades, getPayVsPerformance, getFilingRiskDiff } from './finance/index.js';
...
export function getToolRegistry(model: string): RegisteredTool[] {
  const tools: RegisteredTool[] = [
    ...
    },
    {
      ...
      tool: getCongressionalTrades,
      description: getCongressionalTrades.description,
      compactDescription: 'Recent stock trades by members of Congress.',
      concurrencySafe: true,
    },
    {
      name: 'get_pay_vs_performance',
      tool: getPayVsPerformance,
      description: getPayVsPerformance.description,
      compactDescription: 'Executive compensation vs company performance data from EDGAR.',
      concurrencySafe: true,
    },
    {
      name: 'get_filing_risk_diff',
      tool: getFilingRiskDiff,
      description: getFilingRiskDiff.description,
      compactDescription: 'Paragraph-level diffs of Risk Factors between recent 10-K filings.',
      concurrencySafe: true,
    },
    {
      name: 'spawn_subagent',
